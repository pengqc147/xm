...
<body style="background-color: #fafafa;">
    ...
    <div class="time">
        ...
        <div class="time_in">
	            <c:forEach items="${starGoods }" var="goods">
        ...
        <div class="app_width">
            ...
            <div class="app_max">
                ...
                <div class="appr">
                    <div class="appr_top">
                    	<!-- 循环后台取到的家电的集合 -->
                    		<c:forEach items="${homeGoods }" var="goods" varStatus="i">
                    		<!--第一排4个商品   -->
	                    		<c:if test="${i.index<4 }">
	                    			<div class="appr_min" id="appr_min1" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;">
	                  					<a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }" target="_blank"><img width="180px" height="180px;" src="<%=imgPath %>${goods.pic }" alt=""></a>
                  			...
                  			<!--第二排4个商品   -->
                  				<c:if test="${i.index>3 }">
	                  				<div class="appr_min" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;margin-top: 15px;" id="appr_min1">
	                  					<a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }"><img width="180px" height="180px;" src="<%=imgPath %>${goods.pic }" alt=""></a>
	                  					<div style="width: 234px;height: 100px;">
	                  						<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname }</div>
	                  						<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial" title="${goods.description }">
	                  							<c:if test="${goods.description.length() <=12 }">
        ...
        <div class="capacity">
            <div class="capa_box_top">
                ...
                <div class="capa_box_top_ar">
                    <div class="capa_box_top_ar_min orangeGL"><a class="" href="">路由器</a></div>
                    <div class="capa_box_top_ar_min orangeGL"><a class="" href="">酷玩</a></div>
                    <div class="capa_box_top_ar_min orangeGL"><a class="" href="">健康</a></div>
                    <div class="capa_box_top_ar_min orangeGL"><a class="" href="">出行</a></div>
                    <div class="capa_box_top_ar_min orangeGL"><a class="" href="">热门</a></div><!-- script_capa_box_top_ar -->
                </div>
            </div>
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
                	<div class="capa_top">
	                	<c:forEach items="${AIGoods }" var="goods">
	                    	<!-- 智能家居 - 动态使用  -->
	                   		<div class="capa capa_shadow" style="width: 231px;height: 301px;text-align: center;background-color: #FFFFFF;margin-top: 15px;">
		                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid }" target="_blank"><img width="180px" height="180px" src="<%=imgPath %>${goods.pic }">
		                            <div  class="tran">
		                                <span class="tran">小米一如既往的好前天下单今天就到了，送货到家很细心的...</span>
		                            </div>
		                        </a>
		                        <div class="capa_a">
		                            <ul>
        ...
        <div class="capacity">
            ...
            <div class="capa_box">
                <div class="capa_top">
					...
					<!-- 动态数据使用，仅供参考 -->
					<c:forEach items="${suggestGoods }" var="goods">
