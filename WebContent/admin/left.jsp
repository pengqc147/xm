...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>小米功能
        ...
        <li><cite></cite><a href="<%=basePath %>user?func=findAllUser" target="rightFrame">用户管理</a><i></i></li>
        <li><cite></cite><a href="<%=basePath %>cate?func=findAllCate" target="rightFrame">商品类别管理</a><i></i></li>
        <li><cite></cite><a href="<%=basePath %>goods?func=findAllGoods" target="rightFrame">商品管理</a><i></i></li>
