    ...
    <input type="hidden" name="gid" value="${goods.gid }" />
	    <ul class="forminfo">
		    ...
		    <li><label>商品展示图</label>
		    	...
		    	<!--先将商品图片显现出来  -->
		    	<img src="<%=imgPath %>${goods.pic }" width="100" height="80"  />
		    	<input type="hidden" name="oldPic" value="${goods.pic }" />
		    </li>
		    <li><label>商品小类别</label>
			    <cite>
				    <input <c:if test="${goods.state == 0 }">checked</c:if> name="state" type="radio" value="0" checked="checked" />正常&nbsp;&nbsp;&nbsp;&nbsp;
		    ...
		    <li><label>生产日期</label>
		    	<input value="<fmt:formatDate value="${goods.product_date }" pattern="yyyy-MM-dd HH:mm:ss" />" class="Wdate" style="width: 345px;height: 32px;line-height: 32px;" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="product_date" type="text" class="dfinput"  />
		    </li>
