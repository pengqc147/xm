...
<body>
    ...
    <div class="rightinfo">
	    ...
	    <table class="tablelist">
	        ...
	        <tbody>
		        <c:forEach items="${goodses }" var="goods" varStatus="i">
		           <tr>
				        ...
				        <td width="20%">${goods.full_description }</td>
				       	<td><img width="100" height="80" src="<%=imgPath %>${goods.pic }" /></td>
				       	<td>
					    ...
					    <td><a style="color :green;" href="<%=basePath %>goods?func=findGoodsById&gid=${goods.gid }">修改</a></td>
			        </tr>
			    </c:forEach>
	        </tbody>
	    </table>
